...
type NavigationTabsProps = {
  activeRoute: 'randomPractice' | 'library';
  onNavigate: (route: 'randomPractice' | 'library') => void;
  t: typeof translations.en;
};

export const NavigationTabs: React.FC<NavigationTabsProps> = ({ activeRoute, onNavigate, t }) => (
