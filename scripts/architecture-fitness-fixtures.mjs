...
test('rejects capability coupling, asserted JSON, and a runtime without disposal evidence', () => {
  fixture((root) => {
    packageAt(
      root,
      'undeclared',
...
test('accepts isolated capabilities, unknown JSON admission, and tested disposal', () => {
  fixture((root) => {
    packageAt(
      root,
      'api-contracts',
